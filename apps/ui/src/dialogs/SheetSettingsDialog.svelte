<script lang="ts">
	...
	import type { SheetSettingsValues } from '../app/appSession.svelte';
	import type { Dict } from '../i18n';
	import { formatLuAsMm } from '../lib/constants';
	import { clampInt } from '../lib/num';
	import Modal from './Modal.svelte';

	type SectionId = 'grid' | 'snap';
	...
	let {
		...
		t: Dict;
		values: SheetSettingsValues;
		onApply: (values: SheetSettingsValues) => void;
		onCancel: () => void;
	} = $props();
...
<Modal
	title={t.sheetSettingsTitle}
	titleId="sheet-settings-title"
	maxWidth="720px"
	maxHeight="520px"
	overflow="hidden"
	onClose={onCancel}
...
>
	<div class="settings">
		<nav class="toc" aria-label={t.sheetSettingsTitle}>
